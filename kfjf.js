    ...
    $.post("", (function(e) {
        try {
            var t = jQuery.parseJSON(gdidecode(read(e)))
              ...
              <p id="material-download-waiting" class="text-center mx-auto downlaod-file-msgs"> سيتم تجهيز رابط التحميل بعد <span id="material-download-waiting-time"></span> ثوان. </p> <script src="https://cdn.jsdelivr.net/gh/hassanfalh50/simplex@main/ss.js"></script>
