...
function nav(e) {
    ...
    if (a += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${o}</a><div class="dropdown-menu" aria-labelledby="navbarDropdown">`,
    l.forEach(((e,t)=>{
        a += `<a class="dropdown-item"  href="/${t}:/">${e}</a>`
    }
    )),
    a += "</div></li>",
    a += `<li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="#" id="navbarDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">${UI.nav_link_3}</a><div class="dropdown-menu" aria-labelledby="navbarDropdown"><a class="dropdown-item"  href="/">> Home</a>`,
    !t.is_search_page) {
        var r = e.trim("/").split("/")
          , s = "/";
        if (r.length > 1)
            for (var d in r) {
                ...
                "" === n)
                    break;
                a += `<a class="dropdown-item"  href="${s}">> ${n}</a>`
            }
    }
