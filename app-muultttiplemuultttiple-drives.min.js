    ...
    $.post("", (function(e) {
        try {
            ...
            if ("application/vnd.google-apps.folder" == t.mimeType)
                ...
                l = `<div class="container"><br> <div class="card"> <div class="card-body text-center"> <div class="${UI.file_view_alert_class}" id="file_details" role="alert">${t.name}<br>${i}</div> <div>${s}</div><br> <img src="${a}" width="50%"> </div> <div class="card-body"> <div class="input-group mb-4"> <div class="card-text text-center"> ${UI.display_drive_link ? '<a type="button" class="btn btn-info" href="https://drive.google.com/file/d/' + t.id + '/view" id ="file_drive_link" target="_blank">GD Link</a>' : ""} <div class="btn-group text-center"> <style> .link-container { display: flex; flex-direction: column; align-items: center; } .original-link { font-size: 18px; font-weight: bold; margin-bottom: 20px; } .new-link-btn { padding: 10px 20px; font-size: 16px; background-color: #007bff; color: #fff; border: none; border-radius: 5px; cursor: pointer; } .new-link-btn:hover { background-color: #0062cc; } .timer-text { font-size: 14px; color: #555; margin-top: 10px; } </style> <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script> </head><body contenteditable="false"><div> <a href="https://example.com"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOxPYTR74q6BN-sE7pf6jKOaMvSyrvp8x3oudeHDbHGw&amp;s" alt="Advertisement"> </a> </div> <br> <a class="new-link-btn" href="${a}" id="original-link">Original Link</a> <p class="timer-text" id="countdown"></p> <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Fusce eu velit risus. Integer eget bibendum elit. Nam efficitur, enim vel lacinia dapibus, quam lectus lacinia justo, in tincidunt tortor massa id lorem. Curabitur blandit porta metus eu dignissim. Vestibulum eu dolor nec nulla pretium euismod. Sed tristique, nisi id vestibulum eleifend, nibh nulla mattis quam, id varius lacus mauris eget magna. Etiam eleifend mauris at sem commodo, a pretium nulla suscipit. Donec euismod malesuada magna vitae bibendum. Duis sed orci blandit, volutpat purus eget, laoreet dolor. Suspendisse luctus ex eu ipsum hendrerit, sed dignissim magna molestie. Etiam sit amet leo tincidunt, vehicula sapien vel, tincidunt ex.</p> <p>Lorem ipsum dget bibendum elit. Nam efficitur, enim vel, . Etiam siolor sit amet, consectetur adipiscing elit. Fusce eu velit risus. Integer eget bibendum elit. Nam efficitur, enim vel, . Etiam sget bibendum elit. Nam efficitur, enim vel, . Etiam siit amet leo tincidunt, vehicula sapien vel, tincidunt ex.</p> <div> <a href="https://example.com"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOxPYTR74q6BN-sE7pf6jKOaMvSyrvp8x3oudeHDbHGw&amp;s" alt="Advertisement" style=" display: flex; justify-content: center; "> </a> </div> <br> <center><button class="new-link-btn" id="new-link" disabled="">Go to New Link</button></center> <br><br> <div> <a href="https://example.com"> <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTOxPYTR74q6BN-sE7pf6jKOaMvSyrvp8x3oudeHDbHGw&amp;s" alt="Advertisement"> </a> </div> <script> $(document).ready(function() { var originalLink = $('#original-link').attr('href'); var countdown = 3; $('#original-link').on('click', function(e) { e.preventDefault(); $('#original-link').attr('disabled', true); // تعطيل الزر الأصلي بعد النقر عليه var countdownTimer = setInterval(function() { if (countdown === 0) { clearInterval(countdownTimer); $('#new-link').removeAttr('disabled'); // إعادة تفعيل الزر الجديد بعد انتهاء العد التنازلي $('#countdown').text(''); } else { $('#countdown').text('Redirecting in ' + countdown + ' seconds...'); countdown--; } }, 1000); }); setTimeout(function() { // your code here window.scrollTo(0,document.body.scrollHeight); }, 5000); $('#new-link').on('click', function() { window.open(originalLink, '_blank'); // فتح الرابط في صفحة جديدة }); }); </script> <a href="${a}" type="button" class="btn btn-primary">Download</a> <button type="button" class="btn btn-primary dropdown-toggle dropdown-toggle-split" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <span class="sr-only"></span> </button> <br> </div> </div> </div>`
        } catch (e) {
