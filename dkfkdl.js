...
<div class="text-center mt-5">
    ...
    <br>
    <p>يرجى الانتظار حتى يتم توليد الرابط ...</p>
    <a  class="alert-success d-none" href="#" id="download-link">حمل الان ....</a>
</div>

<script>
    function goToNewLink() {
        var timer = 5; // تعيين وقت العد التنازلي هنا
